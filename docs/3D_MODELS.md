...
| **ESP32-C3 SuperMini** | [GrabCAD — Ulf Hille's model](https://grabcad.com/library/esp32c3-supermini-1) (free account), or the KiCad-packaged copy at [github.com/mrtnvgr/KiCad_ESP32-C3-SuperMini](https://github.com/mrtnvgr/KiCad_ESP32-C3-SuperMini) (`ESP32-C3-SuperMini.stp`) | STEP / STL | Verified to exist and match (~22.5 × 18 mm). **Not vendored here** — the GitHub repo has no license (all-rights-reserved by default) and the model originates from a GrabCAD upload whose Community License forbids redistribution. Download directly; it's free. |
